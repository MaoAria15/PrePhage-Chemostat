...
ps<-  subset_samples(ps,Sample_time_point %in% group_point[1:8])
Method="bray"
...
t__HMO <- data.frame(Group1=c("Inoculum","Inoculum","Inoculum","Inoculum","Inoculum","Inoculum","Inoculum","Batch1","Batch1","Batch1","Batch1","Batch1","Batch1","Batch2","Batch2","Batch2","Batch2","Batch2","Batch3","Batch3","Batch3","Batch3","Chemostat1","Chemostat1","Chemostat1","Chemostat2","Chemostat2","Chemostat3"),
...
t__Lactose <- data.frame(Group1=c("Inoculum","Inoculum","Inoculum","Inoculum","Inoculum","Inoculum","Inoculum","Batch1","Batch1","Batch1","Batch1","Batch1","Batch1","Batch2","Batch2","Batch2","Batch2","Batch2","Batch3","Batch3","Batch3","Batch3","Chemostat1","Chemostat1","Chemostat1","Chemostat2","Chemostat2","Chemostat3"),
                         Group2=c("Batch1","Batch2","Batch3","Chemostat1","Chemostat2","Chemostat3","Chemostat4","Batch2","Batch3","Chemostat1","Chemostat2","Chemostat3","Chemostat4","Batch3","Chemostat1","Chemostat2","Chemostat3","Chemostat4","Chemostat1","Chemostat2","Chemostat3","Chemostat4","Chemostat2","Chemostat3","Chemostat4","Chemostat3","Chemostat4","Chemostat4"),
                         R2= round(r,digits = 3),
                         F=round(f,digits = 3),
                         p=round(p,digits = 3),
