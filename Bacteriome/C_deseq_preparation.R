...
path_table <- "Bacteriome/stat_result/Chemostat/Deseq/"
...
for (group in Groups){
  ...
  write.table(data.frame(sigtab), paste0(path_table,str_replace(group," ",""),"_HMO_chemostat4.tsv"), sep="\t", col.names = NA)
}
